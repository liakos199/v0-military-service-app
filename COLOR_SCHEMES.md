...
| Card | Navy Zinc | #1a202c | Card backgrounds - better definition |
...
| Secondary | Zinc Gray | #334155 | Secondary elements |
...
| Muted | Zinc | #475569 | Muted elements |
| Muted Foreground | Light Zinc | #cbd5e1 | Muted text |
...
| Element | Color | Hex | Purpose |
|---------|-------|-----|---------|
| Border | Zinc with opacity | rgba(148, 163, 184, 0.2) | Subtle borders |
| Input | Zinc | #1e293b | Input fields |
...
| Chart 3 | Zinc | #64748b | Tertiary data series |
...
- **Zinc Grays**: Balance, neutrality, professionalism
