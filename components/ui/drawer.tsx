  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'group/drawer-content bg-card fixed z-50 flex h-auto flex-col border-border',
        ...
        {...props}
      >
        <div className="bg-muted/50 mx-auto mt-3 hidden h-1 w-8 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
