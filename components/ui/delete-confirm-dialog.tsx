...
export function DeleteConfirmDialog({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[10000] bg-black/75 flex items-end justify-center pb-8 px-4 animate-in fade-in duration-200">
      <div className="bg-zinc-900 border border-zinc-700/50 rounded-[2rem] w-full max-w-sm shadow-2xl p-6 flex flex-col gap-5 animate-in slide-in-from-bottom-4 duration-300">
