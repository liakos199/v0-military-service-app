...
const MILITARY_GUIDES = [
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'Στρατηγική Προσέλευσης',
        items: [
          'Ιδανική άφιξη: 08:00 - 13:00.',
          'Πλεονεκτήματα: Καλύτερα νούμερα σε άρβυλα/στολές, γρήγορη γραφειοκρατία, επιλογή κρεβατιού.',
        ],
      },
      {
        heading: 'Απαγορευμένα Αντικείμενα',
        items: [
          'Αιχμηρά αντικείμενα (μαχαίρια, μεγάλα ψαλίδια).',
          'Οινοπνευματώδη ποτά.',
          'Φάρμακα χωρίς συνταγή γιατρού.',
        ],
      },
      {
        heading: 'Κινητά Τηλέφωνα',
        items: [
          'Επισήμως απαγορεύονται τα smartphones.',
          'Άγραφος κανόνας: Ένα παλιό κινητό για την πύλη, το smartphone καλά κρυμμένο.',
        ],
      },
    ],
  },
  {
    id: 'equipment',
    title: 'Εξοπλισμός & Packing List',
    icon: 'book',
    sections: [
      {
        heading: 'Επιλογή Αρβυλών',
        items: [
          'Πάρτε μισό έως ένα νούμερο μεγαλύτερο.',
          'Χρησιμοποιήστε ανατομικούς πάτους (gel/σιλικόνη).',
          'Φοράτε πάντα χοντρές στρατιωτικές κάλτσες.',
        ],
      },
      {
        heading: 'Απαραίτητα Πολιτικά Είδη',
        items: [
          '8-10 Χακί T-shirts (για να μην πλένετε κάθε μέρα).',
          '8-10 ζεύγη ενισχυμένες κάλτσες.',
          'Υπνόσακος (Sleeping Bag): Ο απόλυτος σωτήρας για υγιεινή και ζέστη.',
          'Μωρομάντηλα: Για σώμα, άρβυλα και όπλο.',
          'Powerbank: Οι πρίζες είναι σπάνιες.',
        ],
      },
      {
        heading: 'Ασφάλεια (Κανόνας των 5)',
        items: [
          '5 λουκέτα με ίδιο κλειδί: Όπλο, Φωριαμός, Λουκάνικο, Σάκος, Κορδόνια αρβυλών.',
        ],
      },
    ],
  },
  {
    id: 'living',
    title: 'Διαβίωση & Ψυχολογία',
    icon: 'book',
    sections: [
      {
        heading: 'Κρεβάτι & Φωριαμός',
        items: [
          'Κάτω κρεβάτι: Εργονομία και ταχύτητα.',
          'Πάνω κρεβάτι: Ιδιωτικότητα και καθαριότητα.',
          'Κλειδώνετε ΠΑΝΤΑ τον φωριαμό σας.',
        ],
      },
      {
        heading: 'Το Τέχνασμα του Υπνόσακου',
        items: [
          'Στρώστε το κρεβάτι τέλεια (φάκελος) από το απόγευμα.',
          'Κοιμηθείτε στον υπνόσακο ΠΑΝΩ από τις κουβέρτες.',
          'Το πρωί απλώς μαζέψτε τον υπνόσακο. Έτοιμοι για επιθεώρηση!',
        ],
      },
      {
        heading: 'Ψυχολογία',
        items: [
          'Κανόνας Αντι-Σύγκρισης: Μην συγκρίνετε τον στρατό με την πολιτική ζωή.',
          'Δείτε το ως ένα προσωρινό project.',
        ],
      },
    ],
  },
...
const GUIDE_QUIZZES: Record<string, QuizQuestion[]> = {
  ...
  'first-day': [
    {
      question: 'Ποιο είναι το ιδανικό χρονικό παράθυρο για κατάταξη;',
      options: ['08:00 - 13:00', '14:00 - 17:00', 'Μετά τη δύση του ηλίου', 'Οποιαδήποτε στιγμή'],
      correctIndex: 0,
    },
    {
      question: 'Τι ισχύει για τα smartphones στην πύλη;',
      options: ['Επιτρέπονται ελεύθερα', 'Απαγορεύονται επίσημα', 'Είναι υποχρεωτικά', 'Δεν υπάρχει κανόνας'],
      correctIndex: 1,
    },
  ],
  equipment: [
    {
      question: 'Τι μέγεθος άρβυλο πρέπει να επιλέξετε;',
      options: ['Το ακριβές νούμερο', 'Μισό έως ένα νούμερο μεγαλύτερο', 'Ένα νούμερο μικρότερο', 'Δύο νούμερα μεγαλύτερα'],
      correctIndex: 1,
    },
    {
      question: 'Πόσα λουκέτα χρειάζονται σύμφωνα με τον κανόνα;',
      options: ['2', '3', '5', '10'],
      correctIndex: 2,
    },
  ],
  living: [
    {
      question: 'Ποιο είναι το πλεονέκτημα του πάνω κρεβατιού;',
      options: ['Εύκολη πρόσβαση', 'Ιδιωτικότητα και καθαριότητα', 'Γρήγορο στρώσιμο', 'Πιο μαλακό στρώμα'],
      correctIndex: 1,
    },
    {
      question: 'Τι είναι το «τέχνασμα του υπνόσακου»;',
      options: ['Κρύψιμο του υπνόσακου', 'Ύπνος πάνω από στρωμένες κουβέρτες', 'Χρήση υπνόσακου ως μαξιλάρι', 'Ύπνος στο πάτωμα'],
      correctIndex: 1,
    },
  ],
}
